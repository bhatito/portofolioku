...
var portofolioTabs = document.getElementsByClassName("portofolio-tab");
...
sr.reveal('.portofolio-container', {origin: 'left'});
sr.reveal('.portofolio-buttons', {origin: 'top'});
sr.reveal('.contact-container', {origin: 'top'});